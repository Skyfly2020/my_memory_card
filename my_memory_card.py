...
###########
AnsGroupBox = QGroupBox("Результат теста")##paint
...
question_list.append(Question('Какое холоднокровное животное меет четырёхкамерное сердце?', 'Крокодил', 'Жаба', 'Змея', 'зелёная черепаха'))
question_list.append(Question('В какой стране самая большая плотность населения?', 'Бангладеш', 'Китай', 'Индия', 'Зимбабве'))
question_list.append(Question('Какая самая большая пустыня в мире?', 'Сахара', 'Гоби', 'Намиб', 'Атакама'))
question_list.append(Question('Чо?', 'ниче', 'ачё', 'харчо', 'тяжёлый'))
question_list.append(Question('1', '2', '3', '4', '5'))
question_list.append(Question('1', '2', '3', '4', '5'))
question_list.append(Question('1', '2', '3', '4', '5'))
question_list.append(Question('1', '2', '3', '4', '5'))
question_list.append(Question('1', '2', '3', '4', '5'))
